...
$string['advancesearch'] = 'Búsqueda avanzada';
...
$string['singlesearch'] = 'Búsqueda simple';
...
$string['recordsperpage'] = 'Cantidad de registros';
$string['recordsperpageinfo'] = 'Tenga cuidado, un número muy alto puede provocar lentitud en la consulta.';
$string['sortby'] = 'Ordenamiento';
